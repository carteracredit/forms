...
export function FieldShowcase() {
	...
	const fieldTypes: FieldType[] = [
		...
		{
			type: "card",
			name: t("fieldTypes.card"),
			icon: <CreditCard className="h-5 w-5" />,
			description: t("fieldLibrary.cardFieldDesc"),
			properties: [
				{
					name: "label",
					type: "string",
				...
				},
				{
					name: "acceptedBrands",
					type: "string[]",
					description: t("fieldProperties.acceptedCardBrands"),
				},
				{
					name: "requireHolderName",
					type: "boolean",
					description: t("fieldProperties.requireHolderName"),
				},
			],
			features: [
				t("fieldLibrary.cardTokenization"),
				t("fieldLibrary.cardFormatting"),
				t("fieldLibrary.cardValidation"),
			],
			inputSchema: {},
			outputSchema: {
				tokenId: "string",
