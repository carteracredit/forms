...
export const translations = {
	en: {
		...
		formDetail: {
			...
			publishConfirm:
				"This will create a new published version with the current draft fields. Continue?",
			publishSuccess: "Form published successfully",
			publishError: "Failed to publish form",
			archive: "Archive",
			archiveForm: "Archive Form",
			archiveConfirm: "Archiving will make this form read-only. Continue?",
			archiveSuccess: "Form archived",
			archiveError: "Failed to archive form",
			formDetails: "Form Details",
			fieldLibrary: "Field Library",
			formFields: "Form Fields",
			draftFields: "Draft Fields",
			noDraftFields: "No draft fields yet. Go to the editor to add fields.",
			noFieldsConfigured:
			...
			versionHistory: "Published Versions",
		...
		formEditor: {
			...
			noChangesDesc:
				"The fields are identical to the current draft. Make changes before saving.",
			...
			publishForm: "Publish Form",
			publishConfirm:
				"This will create a new published version with the current fields. Continue?",
			published: "Form published successfully",
			publishError: "Failed to publish form",
			update: "Update",
			updateForm: "Update published version",
			noFieldsToPublish: "Add at least one field before publishing",
			addField: "Add Field",
		...
		fieldProperties: {
			...
			constraintNone: "No limit",
			constraintFixed: "Fixed date",
			constraintRelative: "Relative to today",
			offsetDirection: "Direction",
			offsetPast: "Before today",
			offsetFuture: "After today",
			offsetYears: "Years",
			offsetMonths: "Months",
			offsetDays: "Days",
			offsetHours: "Hours",
			offsetMinutes: "Minutes",
			offsetPreview: "Resolves to",
			rangeInvalid: "Minimum cannot be after maximum",
		},
		...
		fieldLibrary: {
			...
			relativeMinOffset: "Minimum offset relative to today",
			relativeMaxOffset: "Maximum offset relative to today",
	...
	es: {
		...
		formDetail: {
			...
			publishConfirm:
				"Esto creará una nueva versión publicada con los campos borrador actuales. ¿Continuar?",
			publishSuccess: "Formulario publicado exitosamente",
			publishError: "Error al publicar el formulario",
			archive: "Archivar",
			archiveForm: "Archivar Formulario",
			archiveConfirm:
				"Archivar hará este formulario de solo lectura. ¿Continuar?",
			archiveSuccess: "Formulario archivado",
			archiveError: "Error al archivar el formulario",
			formDetails: "Detalles del Formulario",
			fieldLibrary: "Biblioteca de Campos",
			formFields: "Campos del Formulario",
			draftFields: "Campos Borrador",
			noDraftFields:
				"Aún no hay campos borrador. Ve al editor para agregar campos.",
			noFieldsConfigured:
			...
			versionHistory: "Versiones Publicadas",
		...
		formEditor: {
			...
			noChangesDesc:
				"Los campos son idénticos al borrador actual. Realiza cambios antes de guardar.",
			...
			publishForm: "Publicar Formulario",
			publishConfirm:
				"Esto creará una nueva versión publicada con los campos actuales. ¿Continuar?",
			published: "Formulario publicado exitosamente",
			publishError: "Error al publicar el formulario",
			update: "Actualizar",
			updateForm: "Actualizar versión publicada",
			noFieldsToPublish: "Agrega al menos un campo antes de publicar",
		...
		fieldProperties: {
			...
			constraintNone: "Sin límite",
			constraintFixed: "Fecha fija",
			constraintRelative: "Relativo a hoy",
			offsetDirection: "Dirección",
			offsetPast: "Antes de hoy",
			offsetFuture: "Después de hoy",
			offsetYears: "Años",
			offsetMonths: "Meses",
			offsetDays: "Días",
			offsetHours: "Horas",
			offsetMinutes: "Minutos",
			offsetPreview: "Se resuelve a",
			rangeInvalid: "El mínimo no puede ser posterior al máximo",
		},
		...
		fieldLibrary: {
			...
			relativeMinOffset: "Desplazamiento mínimo relativo a hoy",
			relativeMaxOffset: "Desplazamiento máximo relativo a hoy",
